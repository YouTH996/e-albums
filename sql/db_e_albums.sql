...
CREATE TABLE `tb_bgm_photo` (
  `id` int(11) NOT NULL COMMENT 'id,主键自增',
...
CREATE TABLE `tb_photo` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='照片表';
...
CREATE TABLE `tb_user_photo` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户，照片关联表';
